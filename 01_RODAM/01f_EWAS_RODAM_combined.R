...
# 01f_EWAS_RODAM_combined.R
# Author: Muhulo Muhau Mungamba
# Date: 2025-03-16
#
# EWAS of log-adiponectin in RODAM
# Combined analysis (T2D cases + controls, n = 315)
# Fully adjusted model including diabetes status
############################################
...
# Normalised methylation data (from 01c_normalisation_RODAM.R)
...
# Phenotype file with cell proportions (all participants)
pheno_file <- "2024.10.31_Phenotype_RODAM_combined_n315_MM.csv"
...
write.table(
  final_table,
  "2025.03.16_TopTable_RODAM_Adiponectin_combined_n315.txt",
  sep = "\t",
  quote = FALSE,
  row.names = TRUE,
  col.names = TRUE
