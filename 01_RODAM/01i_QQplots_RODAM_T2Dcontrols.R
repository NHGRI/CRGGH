...
# Date: 2025-03-25
# Analysis: RODAM T2D controls only (n = 203)
############################################
...
############################
# Load EWAS results (T2D controls)
############################

toptablesadip <- read.table(
  "2025.03.16_TopTable_RODAM_Adiponectin_T2Dcontrols_n203_age_sex_cells_pos_batcharry_BMI_site.txt",
  header = TRUE,
  sep = "\t"
)
...
tiff(
  "2025.03.16_QQplot_RODAM_T2Dcontrols_age_sex_cells_batch_pos_BMI_site.tiff",
  width = 1500,
  height = 1500,
  res = 300
)
...
tiff(
  "2025.03.16_QQplot_RODAM_T2Dcontrols_age_sex_cells_batch_pos_BMI_site_bacon.tiff",
  width = 1500,
  height = 1500,
  res = 300
)
...
write.table(
  lambda_results,
  "2025.03.16_Lambda_RODAM_T2Dcontrols.txt",
  sep = "\t",
  quote = FALSE,
  row.names = FALSE
)
