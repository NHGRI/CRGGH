...
# Date: 2025-03-25
# Analysis: RODAM combined (T2D cases + controls)
############################################
...
tiff(
  "2025.10.14_QQplot_RODAM_combined_Adip_age_sex_cells_batch_pos_BMI_site.tiff",
  width = 1500,
  height = 1500,
  res = 300
)
...
tiff(
  "2025.10.14_QQplot_RODAM_combined_Adip_age_sex_cells_batch_pos_BMI_site_bacon.tiff",
  width = 1500,
  height = 1500,
  res = 300
)
...
lambda_results <- data.frame(
  Cohort = "RODAM",
  Group = "Combined (T2D cases + controls)",
...
write.table(
  lambda_results,
  "2025.10.14_Lambda_RODAM_combined.txt",
  sep = "\t",
  quote = FALSE,
  row.names = FALSE
)
