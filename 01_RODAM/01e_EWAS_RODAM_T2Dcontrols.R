...
pheno_file <- "2024.10.31_Phenotype_RODAM_diabetes_control_n203_MM.csv"
...
############################
# Subset: T2D controls only
############################

targets <- targets[targets$DM_Dichot == 0, ]
stopifnot(nrow(targets) == 203)
...
write.table(
  final_table,
  "2025.03.16_TopTable_RODAM_Adiponectin_T2Dcontrols_n203.txt",
  sep = "\t",
  quote = FALSE,
  row.names = TRUE,
  col.names = TRUE
